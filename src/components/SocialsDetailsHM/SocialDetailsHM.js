...
const SocialDetailsHM = ({status, lightBg, mainBold, imgStart, lightTopLine, lightTextDesc, description, main, lightText, topLine, link}) => {
    return(
        <>
...
export default SocialDetailsHM;